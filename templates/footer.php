...
<div class="container">
  <footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 py-3 my-3 border-bottom">
    ...
    <div class="col mb-3">
      ...
      <ul class="nav flex-column">
          ...
          <li class="nav-item mb-2"><a href="https://www.instagram.com/arqfernandezcabrera/" class="nav-link p-0 text-body-secondary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
          ...
          <li class="nav-item mb-2"><a href="https://www.facebook.com/arqfernandezcabrera/" class="nav-link p-0 text-body-secondary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
  ...
  <div class="d-flex flex-column flex-sm-row justify-content-between">
      ...
      <ul class="list-unstyled d-flex">
        ...
        <li class="ms-3"><a class="link-body-emphasis" href="https://github.com/GuidoAsplanatti/ARQWebsite">
        ...
        <li class="ms-3"><a class="link-body-emphasis" href="https://www.linkedin.com/in/asplanattiguido">
